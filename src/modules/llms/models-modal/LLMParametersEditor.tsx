...
export function LLMParametersEditor(props: {
  ...
  return <>
    ...
    {showParam('llmVndOaiWebSearchContext') && (
      <FormSelectControl
        title='Web Search'
        tooltip={isOaiReasoningEffortMinimal ? 'Web search is not compatible with minimal reasoning effort' : 'Controls how much context is retrieved from the web (medium = default for OpenAI). For GPT-5 models, Default=OFF.'}
