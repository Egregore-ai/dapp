...
export function AnthropicServiceSetup(props: { serviceId: DModelsServiceId }) {
  ...
  return <>
    ...
    <ApproximateCosts serviceId={service?.id} whoSaved='Egregore saved you'>
    ...
    {advanced.on && <FormTextField
      ...
      title='API Host'
      description={<>e.g., <Link level='body-sm' href='https://github.com' target='_blank'>bedrock-claude</Link></>}
