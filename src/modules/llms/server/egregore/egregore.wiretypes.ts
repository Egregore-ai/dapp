...
const wireEgregoreModelDetailsSchema = z.object({
 ...
 */
export const wireEgregoreListModelsSchema = z.object({
  models: z.array(z.object({
    name: z.string(),
    modified_at: z.string(),
    size: z.number(),
    // digest: z.string(),
    // details: wireEgregoreModelDetailsSchema.optional(),
  })),
});
 ...
 */
export const wireEgregoreModelInfoSchema = z.object({
  license: z.string().optional(),
  modelfile: z.string(),
  parameters: z.string().optional(),
  template: z.string().optional(),
  details: wireEgregoreModelDetailsSchema.nullable().optional(),
});
 ...
 */
// const wireEgregoreChatCompletionInputSchema = z.object({
//
//   // required
//   model: z.string(),
...
//   // function_call: ...
// });
//export type WireEgregoreChatCompletionInput = z.infer<typeof wireEgregoreChatCompletionInputSchema>;


/**
 * Chat Completion or Generation APIs - Streaming Response
 */
// export const wireEgregoreChunkedOutputSchema = z.union([
