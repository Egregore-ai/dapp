 ...
 *
 ...
 >>>
 */
export const EGREGORE_BASE_MODELS: { [key: string]: { description: string, pulls: number, contextWindow?: number, hasTools?: true, hasVision?: true, isEmbeddings?: true, tags?: string[], added?: string } } = {
  ...
  'olmo2': { description: 'OLMo 2 is a new family of 7B and 13B models trained on up to 5T tokens. These models are on par or better than equivalently sized fully open models, and competitive with open-weight models such as Llama 3.1 on English academic benchmarks.', pulls: 352600, tags: ['7b', '13b'], added: '20250312' },
...
// export const EGREGORE_LAST_UPDATE: string = '20250312';
export const EGREGORE_PREV_UPDATE: string = '20250219';